...
**当前安装状态请看 [Mod 清单（2026-09-16）](MODS.md)**：共 11 个模组，9 个 BepInEx 插件和根之进 0.1.2 允许加载，SPMod 2.4.8 已禁用。背包整理为 2.5.4、隐藏房间提示为 0.7.1。本次重新核对安装元数据并更新清单；历史备份与管理器更新目录可能与本机安装状态不同。
