...
隐藏房间提示 **0.7.1** 已发布：识别沙漠传送石，隐藏入口统一黄色感叹号，打开后清除；场景和完整地图使用相同标记。[源码与说明](workspace/hidden-room-hints/README.md)。48 项模拟检查通过，游戏内待验收。
...
**当前安装状态请看 [Mod 清单（2026-09-22）](MODS.md)**：共 14 个模组，仓库默认启用，包含根之进 0.1.5、SPMod 2.5.3 与锻体 2.8.24。背包整理为 2.5.4、隐藏房间提示为 0.7.1。本次新增按住特殊攻击 1.0.1，其余条目沿用此前核对结果；历史备份与管理器更新目录可能与本机安装状态不同。
