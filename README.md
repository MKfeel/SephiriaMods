...
**当前安装状态请看 [Mod 清单（2026-09-20）](MODS.md)**：共 12 个模组，仓库默认启用，包含根之进 0.1.5、SPMod 2.5.3 与锻体 2.8.24。背包整理为 2.5.4、隐藏房间提示为 0.7.1。本次重新核对安装元数据并更新清单；历史备份与管理器更新目录可能与本机安装状态不同。
